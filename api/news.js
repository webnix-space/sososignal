// /api/news.js — Clean news: CoinTelegraph RSS + CoinGecko news API only
// No SoSoValue calls. No fake static fallback. Transparent when sources fail.
...
export default async function handler(req, res) {
  ...
  res.setHeader('Cache-Control', 's-maxage=600, stale-while-revalidate=1800'); // 10min cache, 30min stale
  ...
  // If NO sources returned anything, return honest error
