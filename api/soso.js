// api/soso.js - Fixed: AbortSignal.timeout() replaced with fetchWithTimeout
// Issues: SSI success:0/5, ETF $0 flows, no per-asset source tracking
...
export default async function handler(req, res) {
  ...
  try {
    ...
    // ─── SSI SECTOR INDICES ───────────────────────────────────────────────────
    // FIXED: Handle partial success (5/7 instead of 0/7)
    if (type === 'sector') {
