// SoDEX API — All pairs with dynamic fallback
// FIXED: No url.parse() usage. Proper error handling. SoDEX primary + CoinGecko fallback + no static fallback.
...
export default async function handler(req, res) {
  ...
  return res.status(503).json({
    ok: false,
    error: 'All live price sources unavailable. SoDEX API and CoinGecko both failed.',
    data: [],
    source: 'none',
    pairCount: 0
  });
